...
What is fixed: 
- Base model: Qwen3-4B
- Training dataset: A fixed set of `{N_TRAIN}` puzzles, frozen and published [here](`{DATASET_LINK}`). Regenerable from [ReasoningGym](https://github.com/open-thought/reasoning-gym).
