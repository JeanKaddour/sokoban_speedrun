...
Same `cnn-mingru` policy, env, and 0.70 target as records #1/#2 — made faster two ways, **both lossless** (fp32, identical math, so the held-out solve-rate ceiling is unchanged):
...
Net: **15:39 vs #2's 21:00** (~26% faster) at a higher worst-seed solve-rate (**0.742 vs 0.727**), both seeds clearing with margin. The win is robust — a per-iter compute reduction, lossless.
...
|---|---|---|---|
| seed42 | 0.7416 | [0.7155, 0.7676] | 15:39 |

**Held-out eval pass@1 0.7416, lower 95% CI 0.7155 vs TARGET 0.7: CLEARS.**
...
- re-ran at seed123 → pass@1 **0.7545** (95% CI [0.7286, 0.7796]) — **CLEARS 0.7** ✓
...
|---|---|---|---|
| submission | seed42 | [source/speedrun_seed42.py](source/speedrun_seed42.py) | `32d64ec3cd67` |
| verification | seed123 | [verification/source/speedrun_seed123.py](verification/source/speedrun_seed123.py) | `32d64ec3cd67` |
